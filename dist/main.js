...
var payment = (function () {
    ...
    payment.prototype.makepaymentFormovie = function (Moviename, place, screen, seats, show) {
        ...
        movie.forEach(function (i) { return console.log(i); });
        if (movie.length !== 0) {
            var se = movie.filter(function (i) { return i.show == show; });
            se.forEach(function (i) { return console.log(i); });
            if (se.length !== 0) {
...
var search = (function () {
    ...
    search.prototype.alldetails = function () {
        console.log("Movie     place      show       Name of screen   available seats");
        for (var _i = 0, _a = search.searchdb; _i < _a.length; _i++) {
            var value = _a[_i];
